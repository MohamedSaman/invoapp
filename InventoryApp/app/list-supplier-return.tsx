...
const mockReturns = [
  { id: 1, returnNo: 'SR001', supplier: 'Ahmad Trading', product: 'Flasher Musical 12 V', quantity: 10, reason: 'Quality Issue', date: '2024-01-15', status: 'Approved' },
  { id: 2, returnNo: 'SR002', supplier: 'Hassan Enterprises', product: 'Ignition Switch', quantity: 5, reason: 'Defective Batch', date: '2024-01-14', status: 'Pending' },
  { id: 3, returnNo: 'SR003', supplier: 'Zarai Auto Parts', product: 'Flasher Electrical 24 V', quantity: 8, reason: 'Damaged in Transit', date: '2024-01-13', status: 'Approved' },
];

export default function ListSupplierReturnScreen() {
  ...
  const filteredReturns = mockReturns.filter(r =>
    ...
    r.supplier.toLowerCase().includes(searchText.toLowerCase()) ||
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.sectionHeader}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>List Supplier Return</Text>
            <Text style={styles.subtitle}>View all supplier returns</Text>
          </View>
        </View>
        ...
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            placeholder="Search return no, supplier, product..."
          ...
          <View style={styles.table}>
            ...
            {filteredReturns.map((ret, index) => (
              <View key={ret.id} style={[styles.tableRow, index % 2 === 0 && styles.tableRowAlternate]}>
                ...
                <Text style={[styles.tableCell, styles.colSupplier]}>{ret.supplier}</Text>
