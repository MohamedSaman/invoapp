...
export default function AddSupplierReturnScreen() {
  ...
  const handleSubmit = () => {
    console.log('Supplier Return submitted:', formData);
    setFormData({
      poNumber: '',
      supplierName: '',
      productName: '',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.sectionHeader}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>Add Supplier Return</Text>
            <Text style={styles.subtitle}>Process supplier return request</Text>
          </View>
        </View>
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              style={styles.input}
              placeholder="Defective, damaged, quality issue..."
              placeholderTextColor="#999"
